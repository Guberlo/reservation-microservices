...
export const ReservationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const handleClose = () => {
    props.history.push('/reservation' + props.location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gcGatewayApp.reservationReservation.delete.question">
        <Translate contentKey="gcGatewayApp.reservationReservation.delete.question" interpolate={{ id: reservationEntity.id }}>
