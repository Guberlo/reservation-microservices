...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gcGatewayApp.usersCustomer.delete.question">
        <Translate contentKey="gcGatewayApp.usersCustomer.delete.question" interpolate={{ id: customerEntity.id }}>
