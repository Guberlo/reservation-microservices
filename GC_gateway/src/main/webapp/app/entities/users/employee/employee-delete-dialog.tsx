...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gcGatewayApp.usersEmployee.delete.question">
        <Translate contentKey="gcGatewayApp.usersEmployee.delete.question" interpolate={{ id: employeeEntity.id }}>
